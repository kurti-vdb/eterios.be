...
const routes: Routes = [
  ...
  { path: 'dashboard/photos', component: ConcessionDashboardComponent, canActivate: [AuthGuard] },
  { path: 'dashboard/concessions', component: ConcessionDashboardComponent, canActivate: [AuthGuard] },
